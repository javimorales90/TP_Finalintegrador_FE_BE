...
$mascota = $stmt->fetch(PDO::FETCH_ASSOC); // trae una mascota
...
<head>
    ...
    <title>Actualizá registro de tu Mascota</title>
...
<h1 class="tituloRegistrar">Actualizá registro de tu Mascota</h1>
...
<form method="post" action="actualizar.php" enctype="multipart/form-data" class="formRegistrar" name="formRegistrar">
  ...
  <div class="mb-3">
    ...
    <input class="form-control" type="file" id="foto" name="foto" value="<?= $mascota ['foto'] ?>">
  </div>
...
<footer class="footerRegistrar"><img src=""></footer>
    ...
    <script> 
      var Provincia = <?= $mascota ['provincia'] ?> 
    </script>
    <script> 
      var Especie = <?= $mascota ['especie'] ?> 
    </script>
    <script src="JS/script.js"></script>
    <script src="JS/scriptModo.js"></script>
    <script src="JS/scriptEvento.js"></script>
    <script src="JS/scriptActualizar.js"></script>
</body>
</html>